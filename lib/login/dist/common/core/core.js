...
/**
 * ## Core.prototype.json2Form
 *
 * 将json数据转成form数据。
 * 
 * 用于发送请求header中"Content-Type"为"application/x-www-form-urlencoded"的数据产生
 *
 * @param {String} json  json数据。
 *
 * @return {String} 返回格式化后端String
 */
_prototype.json2Form = function (json) {
    var str = [];
    for (var p in json) {
